...
from .widgets import ElidedLineEdit, IOLabel


class SalamanderTaskView(ScrollTaskView):
...
class PathDirectorySelector(PathSelector):
    def __init__(self, text, direction="in", parent=None):
        super().__init__(text, direction, parent)
